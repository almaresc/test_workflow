...
package datahub_aml.s_aml_profilatura_estrazione_utenti_aml_0_1;
...
/**
 * Job: S_AML_PROFILATURA_ESTRAZIONE_UTENTI_AML Purpose: estrarre i dati per universo partecipazioni<br>
 * Description:  <br>
 * @author Pietrini, Luca
 * @version 7.3.1.20241003_1446-patch
 * @status 
 */
public class S_AML_PROFILATURA_ESTRAZIONE_UTENTI_AML implements TalendJob {
	static {System.setProperty("TalendJob.log", "S_AML_PROFILATURA_ESTRAZIONE_UTENTI_AML.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(S_AML_PROFILATURA_ESTRAZIONE_UTENTI_AML.class);
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext(){
			...
			if(W_UTENTI_AML != null){
				
					this.setProperty("W_UTENTI_AML", W_UTENTI_AML.toString());
			...
			if(W_FOLDER_OUT_AUTOMAZIONI_CONTROLLI_II_LIV_PROFILATURA != null){
				
					this.setProperty("W_FOLDER_OUT_AUTOMAZIONI_CONTROLLI_II_LIV_PROFILATURA", W_FOLDER_OUT_AUTOMAZIONI_CONTROLLI_II_LIV_PROFILATURA.toString());
...
public String W_UTENTI_AML;
public String getW_UTENTI_AML(){
	return this.W_UTENTI_AML;
}
...
public String W_FOLDER_OUT_AUTOMAZIONI_CONTROLLI_II_LIV_PROFILATURA;
public String getW_FOLDER_OUT_AUTOMAZIONI_CONTROLLI_II_LIV_PROFILATURA(){
	return this.W_FOLDER_OUT_AUTOMAZIONI_CONTROLLI_II_LIV_PROFILATURA;
}
...
public String getW_HIVE_DAVINCI_SANDBOX_TABLE(){
	...
	private final String jobName = "S_AML_PROFILATURA_ESTRAZIONE_UTENTI_AML";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_DLXfoFbWEe64v7MHryVpSg", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				S_AML_PROFILATURA_ESTRAZIONE_UTENTI_AML.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(S_AML_PROFILATURA_ESTRAZIONE_UTENTI_AML.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row_Implicit_Context_RegexStruct implements routines.system.IPersistableRow<row_Implicit_Context_RegexStruct> {
    final static byte[] commonByteArrayLock_DATAHUB_AML_S_AML_PROFILATURA_ESTRAZIONE_UTENTI_AML = new byte[0];
    static byte[] commonByteArray_DATAHUB_AML_S_AML_PROFILATURA_ESTRAZIONE_UTENTI_AML = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DATAHUB_AML_S_AML_PROFILATURA_ESTRAZIONE_UTENTI_AML.length) {
				if(length < 1024 && commonByteArray_DATAHUB_AML_S_AML_PROFILATURA_ESTRAZIONE_UTENTI_AML.length == 0) {
   					commonByteArray_DATAHUB_AML_S_AML_PROFILATURA_ESTRAZIONE_UTENTI_AML = new byte[1024];
				} else {
   					commonByteArray_DATAHUB_AML_S_AML_PROFILATURA_ESTRAZIONE_UTENTI_AML = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DATAHUB_AML_S_AML_PROFILATURA_ESTRAZIONE_UTENTI_AML, 0, length);
			strReturn = new String(commonByteArray_DATAHUB_AML_S_AML_PROFILATURA_ESTRAZIONE_UTENTI_AML, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_DATAHUB_AML_S_AML_PROFILATURA_ESTRAZIONE_UTENTI_AML, 0, length);
			strReturn = new String(commonByteArray_DATAHUB_AML_S_AML_PROFILATURA_ESTRAZIONE_UTENTI_AML, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DATAHUB_AML_S_AML_PROFILATURA_ESTRAZIONE_UTENTI_AML) {
...
if(row_Implicit_Context_Regex != null) { 
  ...
  try{
        ...
        if(key_Implicit_Context_Context!=null && "W_UTENTI_AML".equals(key_Implicit_Context_Context))
        {
           context.W_UTENTI_AML=value_Implicit_Context_Context;
        }
        ...
        if(key_Implicit_Context_Context!=null && "W_FOLDER_OUT_AUTOMAZIONI_CONTROLLI_II_LIV_PROFILATURA".equals(key_Implicit_Context_Context))
        {
           context.W_FOLDER_OUT_AUTOMAZIONI_CONTROLLI_II_LIV_PROFILATURA=value_Implicit_Context_Context;
        }
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tFileList_1{
                    ...
                    log4jParamters_tFileList_1.append("Parameters:");
                        ...
                        log4jParamters_tFileList_1.append(" | ");
                            log4jParamters_tFileList_1.append("FILES" + " = " + "[{FILEMASK="+("\"*\"+context.W_UTENTI_AML+\"*.csv\"")+"}]");
                        log4jParamters_tFileList_1.append(" | ");
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_1.add("*"+context.W_UTENTI_AML+"*.csv");  
...
//String name = context.W_ANAGRAFICA_DEB_CREB;
...
System.out.println(context.W_FOLDER_IN_AUTOMAZIONI_CONTROLLI_II_LIV_PROFILATURA);
                ...
                class BytesLimit65535_tRunJob_1{
                    ...
                    log4jParamters_tRunJob_1.append("Parameters:");
                        ...
                        log4jParamters_tRunJob_1.append(" | ");
                            log4jParamters_tRunJob_1.append("PROCESS" + " = " + "S_AML_PROFILATURA_COPY_FILE_TO_EDH");
                        log4jParamters_tRunJob_1.append(" | ");
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_1 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_1 {
                    ...
                    parentContextMap_tRunJob_1.put("W_JOB_PRINCIPALE", context.W_JOB_PRINCIPALE);
                    paraList_tRunJob_1.add("--context_type " + "W_JOB_PRINCIPALE" + "=" + "id_String");
                    parentContextMap_tRunJob_1.put("W_PROJECT_NAME", context.W_PROJECT_NAME);
                    paraList_tRunJob_1.add("--context_type " + "W_PROJECT_NAME" + "=" + "id_String");
                    parentContextMap_tRunJob_1.put("CONTEXT_SALE_FILE_NAME", context.CONTEXT_SALE_FILE_NAME);
                    paraList_tRunJob_1.add("--context_type " + "CONTEXT_SALE_FILE_NAME" + "=" + "id_String");
                    parentContextMap_tRunJob_1.put("W_INIZIO_DATE", context.W_INIZIO_DATE);
                    paraList_tRunJob_1.add("--context_type " + "W_INIZIO_DATE" + "=" + "id_String");
                    parentContextMap_tRunJob_1.put("W_FINE_DATE", context.W_FINE_DATE);
                    paraList_tRunJob_1.add("--context_type " + "W_FINE_DATE" + "=" + "id_String");
                    parentContextMap_tRunJob_1.put("data_riferimento", context.data_riferimento);
                    paraList_tRunJob_1.add("--context_type " + "data_riferimento" + "=" + "id_String");
                    parentContextMap_tRunJob_1.put("W_FILE_NAME_ESITI_CONTROLLO", context.W_FILE_NAME_ESITI_CONTROLLO);
                    paraList_tRunJob_1.add("--context_type " + "W_FILE_NAME_ESITI_CONTROLLO" + "=" + "id_String");
                    parentContextMap_tRunJob_1.put("W_DATA_RIFERIMENTO", context.W_DATA_RIFERIMENTO);
                    paraList_tRunJob_1.add("--context_type " + "W_DATA_RIFERIMENTO" + "=" + "id_String");
                    parentContextMap_tRunJob_1.put("W_FLAG_REG_AUI", context.W_FLAG_REG_AUI);
                    paraList_tRunJob_1.add("--context_type " + "W_FLAG_REG_AUI" + "=" + "id_String");
                    parentContextMap_tRunJob_1.put("W_CRAP", context.W_CRAP);
                    paraList_tRunJob_1.add("--context_type " + "W_CRAP" + "=" + "id_String");
                    parentContextMap_tRunJob_1.put("W_NDG", context.W_NDG);
                    paraList_tRunJob_1.add("--context_type " + "W_NDG" + "=" + "id_String");
                    parentContextMap_tRunJob_1.put("W_UTENTI_AML", context.W_UTENTI_AML);
                    paraList_tRunJob_1.add("--context_type " + "W_UTENTI_AML" + "=" + "id_String");
                    parentContextMap_tRunJob_1.put("W_NAME_TFILE_LIST", context.W_NAME_TFILE_LIST);
                    paraList_tRunJob_1.add("--context_type " + "W_NAME_TFILE_LIST" + "=" + "id_String");
                    ...
                    parentContextMap_tRunJob_1.put("DB_POSTGRES_POC_Database", context.DB_POSTGRES_POC_Database);
                    paraList_tRunJob_1.add("--context_type " + "DB_POSTGRES_POC_Database" + "=" + "id_String");
                    parentContextMap_tRunJob_1.put("DB_POSTGRES_POC_Login", context.DB_POSTGRES_POC_Login);
                    paraList_tRunJob_1.add("--context_type " + "DB_POSTGRES_POC_Login" + "=" + "id_String");
                    parentContextMap_tRunJob_1.put("DB_POSTGRES_POC_Password", context.DB_POSTGRES_POC_Password);
                    paraList_tRunJob_1.add("--context_type " + "DB_POSTGRES_POC_Password" + "=" + "id_Password");
                    parentContextMap_tRunJob_1.put("DB_POSTGRES_POC_Port", context.DB_POSTGRES_POC_Port);
                    paraList_tRunJob_1.add("--context_type " + "DB_POSTGRES_POC_Port" + "=" + "id_String");
                    parentContextMap_tRunJob_1.put("DB_POSTGRES_POC_Schema", context.DB_POSTGRES_POC_Schema);
                    paraList_tRunJob_1.add("--context_type " + "DB_POSTGRES_POC_Schema" + "=" + "id_String");
                    parentContextMap_tRunJob_1.put("DB_POSTGRES_POC_Server", context.DB_POSTGRES_POC_Server);
                    paraList_tRunJob_1.add("--context_type " + "DB_POSTGRES_POC_Server" + "=" + "id_String");
                    ...
                    parentContextMap_tRunJob_1.put("W_CONTEXT_TYPE", context.W_CONTEXT_TYPE);
                    paraList_tRunJob_1.add("--context_type " + "W_CONTEXT_TYPE" + "=" + "id_String");
                    parentContextMap_tRunJob_1.put("W_DAVINCI_TABELLA_TARGET", context.W_DAVINCI_TABELLA_TARGET);
                    paraList_tRunJob_1.add("--context_type " + "W_DAVINCI_TABELLA_TARGET" + "=" + "id_String");
                    parentContextMap_tRunJob_1.put("W_DB_ANDC_DH", context.W_DB_ANDC_DH);
                    paraList_tRunJob_1.add("--context_type " + "W_DB_ANDC_DH" + "=" + "id_String");
                    parentContextMap_tRunJob_1.put("W_DB_ANDC_ETL", context.W_DB_ANDC_ETL);
                    paraList_tRunJob_1.add("--context_type " + "W_DB_ANDC_ETL" + "=" + "id_String");
                    parentContextMap_tRunJob_1.put("W_DB_DAVINCI_POSTGRES_CUSTOM_LOG_TABLE", context.W_DB_DAVINCI_POSTGRES_CUSTOM_LOG_TABLE);
                    paraList_tRunJob_1.add("--context_type " + "W_DB_DAVINCI_POSTGRES_CUSTOM_LOG_TABLE" + "=" + "id_String");
                    parentContextMap_tRunJob_1.put("W_DB_DAVINCI_POSTGRES_FILE_METADATA_TABLE", context.W_DB_DAVINCI_POSTGRES_FILE_METADATA_TABLE);
                    paraList_tRunJob_1.add("--context_type " + "W_DB_DAVINCI_POSTGRES_FILE_METADATA_TABLE" + "=" + "id_String");
                    parentContextMap_tRunJob_1.put("W_DB_DAVINCI_POSTGRES_STATEMENT_TABLE", context.W_DB_DAVINCI_POSTGRES_STATEMENT_TABLE);
                    paraList_tRunJob_1.add("--context_type " + "W_DB_DAVINCI_POSTGRES_STATEMENT_TABLE" + "=" + "id_String");
                    parentContextMap_tRunJob_1.put("W_FOLDER_CSV", context.W_FOLDER_CSV);
                    paraList_tRunJob_1.add("--context_type " + "W_FOLDER_CSV" + "=" + "id_String");
                    parentContextMap_tRunJob_1.put("W_FOLDER_CSV_EXPORT", context.W_FOLDER_CSV_EXPORT);
                    paraList_tRunJob_1.add("--context_type " + "W_FOLDER_CSV_EXPORT" + "=" + "id_String");
                    parentContextMap_tRunJob_1.put("W_FOLDER_IN_AUTOMAZIONI_CONTROLLI_II_LIV_PROFILATURA", context.W_FOLDER_IN_AUTOMAZIONI_CONTROLLI_II_LIV_PROFILATURA);
                    paraList_tRunJob_1.add("--context_type " + "W_FOLDER_IN_AUTOMAZIONI_CONTROLLI_II_LIV_PROFILATURA" + "=" + "id_String");
                    parentContextMap_tRunJob_1.put("W_FOLDER_OUT_AUTOMAZIONI_CONTROLLI_II_LIV_PROFILATURA", context.W_FOLDER_OUT_AUTOMAZIONI_CONTROLLI_II_LIV_PROFILATURA);
                    paraList_tRunJob_1.add("--context_type " + "W_FOLDER_OUT_AUTOMAZIONI_CONTROLLI_II_LIV_PROFILATURA" + "=" + "id_String");
                    parentContextMap_tRunJob_1.put("W_HDFS_DAVINCI_ETL", context.W_HDFS_DAVINCI_ETL);
                    paraList_tRunJob_1.add("--context_type " + "W_HDFS_DAVINCI_ETL" + "=" + "id_String");
                    parentContextMap_tRunJob_1.put("W_HDFS_DH", context.W_HDFS_DH);
                    paraList_tRunJob_1.add("--context_type " + "W_HDFS_DH" + "=" + "id_String");
                    parentContextMap_tRunJob_1.put("W_HDFS_ETL", context.W_HDFS_ETL);
                    paraList_tRunJob_1.add("--context_type " + "W_HDFS_ETL" + "=" + "id_String");
                    parentContextMap_tRunJob_1.put("W_HIVE_DAVINCI_SANDBOX_DB", context.W_HIVE_DAVINCI_SANDBOX_DB);
                    paraList_tRunJob_1.add("--context_type " + "W_HIVE_DAVINCI_SANDBOX_DB" + "=" + "id_String");
                    parentContextMap_tRunJob_1.put("W_HIVE_DAVINCI_SANDBOX_TABLE", context.W_HIVE_DAVINCI_SANDBOX_TABLE);
                    paraList_tRunJob_1.add("--context_type " + "W_HIVE_DAVINCI_SANDBOX_TABLE" + "=" + "id_String");
                        }
	...
	Object obj_tRunJob_1 = null;
		...
		datahub_aml.s_aml_profilatura_copy_file_to_edh_0_1.S_AML_PROFILATURA_COPY_FILE_TO_EDH childJob_tRunJob_1 = new datahub_aml.s_aml_profilatura_copy_file_to_edh_0_1.S_AML_PROFILATURA_COPY_FILE_TO_EDH();
	    // pass DataSources
	    ...
	    if (null != talendDataSources_tRunJob_1) {
			...
			log.info("tRunJob_1 - The child job 'datahub_aml.s_aml_profilatura_copy_file_to_edh_0_1.S_AML_PROFILATURA_COPY_FILE_TO_EDH' starts on the version '0.1' with the context 'Default'.");
		
		String[][] childReturn_tRunJob_1 = childJob_tRunJob_1.runJob((String[]) paraList_tRunJob_1.toArray(new String[paraList_tRunJob_1.size()]));
		
			log.info("tRunJob_1 - The child job 'datahub_aml.s_aml_profilatura_copy_file_to_edh_0_1.S_AML_PROFILATURA_COPY_FILE_TO_EDH' is done.");
 ...
 */
    ...
    public static void main(String[] args){
        final S_AML_PROFILATURA_ESTRAZIONE_UTENTI_AML S_AML_PROFILATURA_ESTRAZIONE_UTENTI_AMLClass = new S_AML_PROFILATURA_ESTRAZIONE_UTENTI_AML();

        int exitCode = S_AML_PROFILATURA_ESTRAZIONE_UTENTI_AMLClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'S_AML_PROFILATURA_ESTRAZIONE_UTENTI_AML' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
			...
			log.info("TalendJob: 'S_AML_PROFILATURA_ESTRAZIONE_UTENTI_AML' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = S_AML_PROFILATURA_ESTRAZIONE_UTENTI_AML.class.getClassLoader().getResourceAsStream("datahub_aml/s_aml_profilatura_estrazione_utenti_aml_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = S_AML_PROFILATURA_ESTRAZIONE_UTENTI_AML.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
            ...
            class ContextProcessing {
                private void processContext_0() {
                        ...
                        context.setContextType("W_UTENTI_AML", "id_String");
                        if(context.getStringValue("W_UTENTI_AML") == null) {
                            context.W_UTENTI_AML = null;
                        } else {
                            context.W_UTENTI_AML=(String) context.getProperty("W_UTENTI_AML");
                        }
                        ...
                        context.setContextType("W_FOLDER_OUT_AUTOMAZIONI_CONTROLLI_II_LIV_PROFILATURA", "id_String");
                        if(context.getStringValue("W_FOLDER_OUT_AUTOMAZIONI_CONTROLLI_II_LIV_PROFILATURA") == null) {
                            context.W_FOLDER_OUT_AUTOMAZIONI_CONTROLLI_II_LIV_PROFILATURA = null;
                        } else {
                            context.W_FOLDER_OUT_AUTOMAZIONI_CONTROLLI_II_LIV_PROFILATURA=(String) context.getProperty("W_FOLDER_OUT_AUTOMAZIONI_CONTROLLI_II_LIV_PROFILATURA");
                        }
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("W_JOB_PRINCIPALE")) {
            ...
            }if (parentContextMap.containsKey("W_UTENTI_AML")) {
                context.W_UTENTI_AML = (String) parentContextMap.get("W_UTENTI_AML");
            ...
            }if (parentContextMap.containsKey("W_FOLDER_OUT_AUTOMAZIONI_CONTROLLI_II_LIV_PROFILATURA")) {
                context.W_FOLDER_OUT_AUTOMAZIONI_CONTROLLI_II_LIV_PROFILATURA = (String) parentContextMap.get("W_FOLDER_OUT_AUTOMAZIONI_CONTROLLI_II_LIV_PROFILATURA");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : S_AML_PROFILATURA_ESTRAZIONE_UTENTI_AML");
        }
		if(enableLogStash) {
...
/************************************************************************************************
 *     244352 characters generated by Talend Big Data Platform 
 *     on the 6 febbraio 2026 14.56.09 CET
 ************************************************************************************************/