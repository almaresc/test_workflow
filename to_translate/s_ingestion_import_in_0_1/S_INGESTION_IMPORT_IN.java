...
package datahub_aml.s_ingestion_import_in_0_1;
...
/**
 * Job: S_INGESTION_IMPORT_IN Purpose: <br>
 * Description:  <br>
 * @author Pietrini, Luca
 * @version 7.3.1.20241003_1446-patch
 * @status 
 */
public class S_INGESTION_IMPORT_IN implements TalendJob {
	static {System.setProperty("TalendJob.log", "S_INGESTION_IMPORT_IN.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(S_INGESTION_IMPORT_IN.class);
...
public String getDB_POSTGRES_configuration_metadata(){
	...
	private final String jobName = "S_INGESTION_IMPORT_IN";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_qLA7UJ8sEemYyclkQ7q9rw", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				S_INGESTION_IMPORT_IN.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(S_INGESTION_IMPORT_IN.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row_Implicit_Context_RegexStruct implements routines.system.IPersistableRow<row_Implicit_Context_RegexStruct> {
    final static byte[] commonByteArrayLock_DATAHUB_AML_S_INGESTION_IMPORT_IN = new byte[0];
    static byte[] commonByteArray_DATAHUB_AML_S_INGESTION_IMPORT_IN = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DATAHUB_AML_S_INGESTION_IMPORT_IN.length) {
				if(length < 1024 && commonByteArray_DATAHUB_AML_S_INGESTION_IMPORT_IN.length == 0) {
   					commonByteArray_DATAHUB_AML_S_INGESTION_IMPORT_IN = new byte[1024];
				} else {
   					commonByteArray_DATAHUB_AML_S_INGESTION_IMPORT_IN = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DATAHUB_AML_S_INGESTION_IMPORT_IN, 0, length);
			strReturn = new String(commonByteArray_DATAHUB_AML_S_INGESTION_IMPORT_IN, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_DATAHUB_AML_S_INGESTION_IMPORT_IN, 0, length);
			strReturn = new String(commonByteArray_DATAHUB_AML_S_INGESTION_IMPORT_IN, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DATAHUB_AML_S_INGESTION_IMPORT_IN) {
...
System.out.println("File o Tabella? ");
...
end_Hash.put("tJava_1", System.currentTimeMillis());
   			...
   			if (!context.W_DATA_TYPE.toLowerCase().equals("file")) {
                ...
                class BytesLimit65535_tRunJob_1{
                    ...
                    log4jParamters_tRunJob_1.append("Parameters:");
                        ...
                        log4jParamters_tRunJob_1.append(" | ");
                            log4jParamters_tRunJob_1.append("PROCESS" + " = " + "S_INGESTION_IMPORT_TABELLA");
                        log4jParamters_tRunJob_1.append(" | ");
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_1 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_1 {
                    ...
                    parentContextMap_tRunJob_1.put("DB_CONNECTION_Database", context.DB_CONNECTION_Database);
                    paraList_tRunJob_1.add("--context_type " + "DB_CONNECTION_Database" + "=" + "id_String");
                    parentContextMap_tRunJob_1.put("DB_CONNECTION_Login", context.DB_CONNECTION_Login);
                    paraList_tRunJob_1.add("--context_type " + "DB_CONNECTION_Login" + "=" + "id_String");
                    parentContextMap_tRunJob_1.put("DB_CONNECTION_Password", context.DB_CONNECTION_Password);
                    paraList_tRunJob_1.add("--context_type " + "DB_CONNECTION_Password" + "=" + "id_String");
                    parentContextMap_tRunJob_1.put("DB_CONNECTION_Port", context.DB_CONNECTION_Port);
                    paraList_tRunJob_1.add("--context_type " + "DB_CONNECTION_Port" + "=" + "id_String");
                    parentContextMap_tRunJob_1.put("DB_CONNECTION_Server", context.DB_CONNECTION_Server);
                    paraList_tRunJob_1.add("--context_type " + "DB_CONNECTION_Server" + "=" + "id_String");
	...
	Object obj_tRunJob_1 = null;
		...
		datahub_aml.s_ingestion_import_tabella_0_1.S_INGESTION_IMPORT_TABELLA childJob_tRunJob_1 = new datahub_aml.s_ingestion_import_tabella_0_1.S_INGESTION_IMPORT_TABELLA();
	    // pass DataSources
	    ...
	    if (null != talendDataSources_tRunJob_1) {
			...
			log.info("tRunJob_1 - The child job 'datahub_aml.s_ingestion_import_tabella_0_1.S_INGESTION_IMPORT_TABELLA' starts on the version '0.1' with the context 'LOCAL'.");
		
		String[][] childReturn_tRunJob_1 = childJob_tRunJob_1.runJob((String[]) paraList_tRunJob_1.toArray(new String[paraList_tRunJob_1.size()]));
		
			log.info("tRunJob_1 - The child job 'datahub_aml.s_ingestion_import_tabella_0_1.S_INGESTION_IMPORT_TABELLA' is done.");
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tRunJob_2";
		...
		int tos_count_tRunJob_2 = 0;
                ...
                class BytesLimit65535_tRunJob_2{
                    ...
                    log4jParamters_tRunJob_2.append("Parameters:");
                        ...
                        log4jParamters_tRunJob_2.append(" | ");
                            log4jParamters_tRunJob_2.append("PROCESS" + " = " + "S_INGESTION_IMPORT_FILE_1");
                        log4jParamters_tRunJob_2.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tRunJob_2", "__PROCESS__", "tRunJob");
				talendJobLogProcess(globalMap);
			}
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_2 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_2 {
                    private void transmitContext_0() {
                    parentContextMap_tRunJob_2.put("W_BUSINESS_GROUP", context.W_BUSINESS_GROUP);
                    paraList_tRunJob_2.add("--context_type " + "W_BUSINESS_GROUP" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("W_BUSINESS_NAME", context.W_BUSINESS_NAME);
                    paraList_tRunJob_2.add("--context_type " + "W_BUSINESS_NAME" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("W_DATA_TYPE", context.W_DATA_TYPE);
                    paraList_tRunJob_2.add("--context_type " + "W_DATA_TYPE" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("W_DEFAULT_PARTITION", context.W_DEFAULT_PARTITION);
                    paraList_tRunJob_2.add("--context_type " + "W_DEFAULT_PARTITION" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("W_EDH_DB_ARCHIN", context.W_EDH_DB_ARCHIN);
                    paraList_tRunJob_2.add("--context_type " + "W_EDH_DB_ARCHIN" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("W_EDH_DB_H", context.W_EDH_DB_H);
                    paraList_tRunJob_2.add("--context_type " + "W_EDH_DB_H" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("W_EDH_DB_IN", context.W_EDH_DB_IN);
                    paraList_tRunJob_2.add("--context_type " + "W_EDH_DB_IN" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("W_EDH_TABLE_ARCHIN", context.W_EDH_TABLE_ARCHIN);
                    paraList_tRunJob_2.add("--context_type " + "W_EDH_TABLE_ARCHIN" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("W_EDH_TABLE_H", context.W_EDH_TABLE_H);
                    paraList_tRunJob_2.add("--context_type " + "W_EDH_TABLE_H" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("W_EDH_TABLE_IN", context.W_EDH_TABLE_IN);
                    paraList_tRunJob_2.add("--context_type " + "W_EDH_TABLE_IN" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("W_EXTRACTION_FIELDS", context.W_EXTRACTION_FIELDS);
                    paraList_tRunJob_2.add("--context_type " + "W_EXTRACTION_FIELDS" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("W_F_FILEMASK", context.W_F_FILEMASK);
                    paraList_tRunJob_2.add("--context_type " + "W_F_FILEMASK" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("W_FILENAME", context.W_FILENAME);
                    paraList_tRunJob_2.add("--context_type " + "W_FILENAME" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("W_FLAG_ABILITATA", context.W_FLAG_ABILITATA);
                    paraList_tRunJob_2.add("--context_type " + "W_FLAG_ABILITATA" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("W_FLAG_HEADER", context.W_FLAG_HEADER);
                    paraList_tRunJob_2.add("--context_type " + "W_FLAG_HEADER" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("W_HDFS_ETL_PATH", context.W_HDFS_ETL_PATH);
                    paraList_tRunJob_2.add("--context_type " + "W_HDFS_ETL_PATH" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("W_IMPORT_TYPE", context.W_IMPORT_TYPE);
                    paraList_tRunJob_2.add("--context_type " + "W_IMPORT_TYPE" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("W_LAST_PARTITION", context.W_LAST_PARTITION);
                    paraList_tRunJob_2.add("--context_type " + "W_LAST_PARTITION" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("W_MAPPER", context.W_MAPPER);
                    paraList_tRunJob_2.add("--context_type " + "W_MAPPER" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("W_PARTITION_FIELD", context.W_PARTITION_FIELD);
                    paraList_tRunJob_2.add("--context_type " + "W_PARTITION_FIELD" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("W_PATH_ARCHIN", context.W_PATH_ARCHIN);
                    paraList_tRunJob_2.add("--context_type " + "W_PATH_ARCHIN" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("W_PATH_IN", context.W_PATH_IN);
                    paraList_tRunJob_2.add("--context_type " + "W_PATH_IN" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("W_SOURCE_NAME", context.W_SOURCE_NAME);
                    paraList_tRunJob_2.add("--context_type " + "W_SOURCE_NAME" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("W_T_SOURCE_DATABASE", context.W_T_SOURCE_DATABASE);
                    paraList_tRunJob_2.add("--context_type " + "W_T_SOURCE_DATABASE" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("W_T_SOURCE_TABLE", context.W_T_SOURCE_TABLE);
                    paraList_tRunJob_2.add("--context_type " + "W_T_SOURCE_TABLE" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("DB_CONNECTION_Database", context.DB_CONNECTION_Database);
                    paraList_tRunJob_2.add("--context_type " + "DB_CONNECTION_Database" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("DB_CONNECTION_Login", context.DB_CONNECTION_Login);
                    paraList_tRunJob_2.add("--context_type " + "DB_CONNECTION_Login" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("DB_CONNECTION_Password", context.DB_CONNECTION_Password);
                    paraList_tRunJob_2.add("--context_type " + "DB_CONNECTION_Password" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("DB_CONNECTION_Port", context.DB_CONNECTION_Port);
                    paraList_tRunJob_2.add("--context_type " + "DB_CONNECTION_Port" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("DB_CONNECTION_Server", context.DB_CONNECTION_Server);
                    paraList_tRunJob_2.add("--context_type " + "DB_CONNECTION_Server" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("DB_POSTGRES_CUSTOM_LOG_TABLE", context.DB_POSTGRES_CUSTOM_LOG_TABLE);
                    paraList_tRunJob_2.add("--context_type " + "DB_POSTGRES_CUSTOM_LOG_TABLE" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("DB_POSTGRES_Database", context.DB_POSTGRES_Database);
                    paraList_tRunJob_2.add("--context_type " + "DB_POSTGRES_Database" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("DB_POSTGRES_FILE_METADATA_TABLE", context.DB_POSTGRES_FILE_METADATA_TABLE);
                    paraList_tRunJob_2.add("--context_type " + "DB_POSTGRES_FILE_METADATA_TABLE" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("DB_POSTGRES_LOG_TABLE", context.DB_POSTGRES_LOG_TABLE);
                    paraList_tRunJob_2.add("--context_type " + "DB_POSTGRES_LOG_TABLE" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("DB_POSTGRES_Login", context.DB_POSTGRES_Login);
                    paraList_tRunJob_2.add("--context_type " + "DB_POSTGRES_Login" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("DB_POSTGRES_LOGTABLE", context.DB_POSTGRES_LOGTABLE);
                    paraList_tRunJob_2.add("--context_type " + "DB_POSTGRES_LOGTABLE" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("DB_POSTGRES_LOGVIEW", context.DB_POSTGRES_LOGVIEW);
                    paraList_tRunJob_2.add("--context_type " + "DB_POSTGRES_LOGVIEW" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("DB_POSTGRES_METADATA_FACT_RECUPERO_PARTIZIONI", context.DB_POSTGRES_METADATA_FACT_RECUPERO_PARTIZIONI);
                    paraList_tRunJob_2.add("--context_type " + "DB_POSTGRES_METADATA_FACT_RECUPERO_PARTIZIONI" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("DB_POSTGRES_METADATA_FACT_TABLE", context.DB_POSTGRES_METADATA_FACT_TABLE);
                    paraList_tRunJob_2.add("--context_type " + "DB_POSTGRES_METADATA_FACT_TABLE" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("DB_POSTGRES_Password", context.DB_POSTGRES_Password);
                    paraList_tRunJob_2.add("--context_type " + "DB_POSTGRES_Password" + "=" + "id_Password");
                    parentContextMap_tRunJob_2.put("DB_POSTGRES_Port", context.DB_POSTGRES_Port);
                    paraList_tRunJob_2.add("--context_type " + "DB_POSTGRES_Port" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("DB_POSTGRES_Schema", context.DB_POSTGRES_Schema);
                    paraList_tRunJob_2.add("--context_type " + "DB_POSTGRES_Schema" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("DB_POSTGRES_Server", context.DB_POSTGRES_Server);
                    paraList_tRunJob_2.add("--context_type " + "DB_POSTGRES_Server" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("DB_POSTGRES_SQOOP_METADATA_TABLE", context.DB_POSTGRES_SQOOP_METADATA_TABLE);
                    paraList_tRunJob_2.add("--context_type " + "DB_POSTGRES_SQOOP_METADATA_TABLE" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("DB_POSTGRES_STATTABLE", context.DB_POSTGRES_STATTABLE);
                    paraList_tRunJob_2.add("--context_type " + "DB_POSTGRES_STATTABLE" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("EDH_CLUSTER_dfs_client_failover_proxy_provider_edhcluster", context.EDH_CLUSTER_dfs_client_failover_proxy_provider_edhcluster);
                    paraList_tRunJob_2.add("--context_type " + "EDH_CLUSTER_dfs_client_failover_proxy_provider_edhcluster" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("EDH_CLUSTER_dfs_ha_namenodes_edhcluster", context.EDH_CLUSTER_dfs_ha_namenodes_edhcluster);
                    paraList_tRunJob_2.add("--context_type " + "EDH_CLUSTER_dfs_ha_namenodes_edhcluster" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("EDH_CLUSTER_dfs_namenode_rpc_address_edhcluster_namenode209", context.EDH_CLUSTER_dfs_namenode_rpc_address_edhcluster_namenode209);
                    paraList_tRunJob_2.add("--context_type " + "EDH_CLUSTER_dfs_namenode_rpc_address_edhcluster_namenode209" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("EDH_CLUSTER_dfs_namenode_rpc_address_edhcluster_namenode264", context.EDH_CLUSTER_dfs_namenode_rpc_address_edhcluster_namenode264);
                    paraList_tRunJob_2.add("--context_type " + "EDH_CLUSTER_dfs_namenode_rpc_address_edhcluster_namenode264" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("EDH_CLUSTER_dfs_nameservices", context.EDH_CLUSTER_dfs_nameservices);
                    paraList_tRunJob_2.add("--context_type " + "EDH_CLUSTER_dfs_nameservices" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("EDH_CLUSTER_ha_zookeeper_quorum", context.EDH_CLUSTER_ha_zookeeper_quorum);
                    paraList_tRunJob_2.add("--context_type " + "EDH_CLUSTER_ha_zookeeper_quorum" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("EDH_CLUSTER_JobHistory", context.EDH_CLUSTER_JobHistory);
                    paraList_tRunJob_2.add("--context_type " + "EDH_CLUSTER_JobHistory" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("EDH_CLUSTER_JobHistroyPrin", context.EDH_CLUSTER_JobHistroyPrin);
                    paraList_tRunJob_2.add("--context_type " + "EDH_CLUSTER_JobHistroyPrin" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("EDH_CLUSTER_JTOrRMPrin", context.EDH_CLUSTER_JTOrRMPrin);
                    paraList_tRunJob_2.add("--context_type " + "EDH_CLUSTER_JTOrRMPrin" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("EDH_CLUSTER_KeyTab", context.EDH_CLUSTER_KeyTab);
                    paraList_tRunJob_2.add("--context_type " + "EDH_CLUSTER_KeyTab" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("EDH_CLUSTER_NameNodePrin", context.EDH_CLUSTER_NameNodePrin);
                    paraList_tRunJob_2.add("--context_type " + "EDH_CLUSTER_NameNodePrin" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("EDH_CLUSTER_NameNodeUri", context.EDH_CLUSTER_NameNodeUri);
                    paraList_tRunJob_2.add("--context_type " + "EDH_CLUSTER_NameNodeUri" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("EDH_CLUSTER_Principal", context.EDH_CLUSTER_Principal);
                    paraList_tRunJob_2.add("--context_type " + "EDH_CLUSTER_Principal" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("EDH_CLUSTER_ResourceManager", context.EDH_CLUSTER_ResourceManager);
                    paraList_tRunJob_2.add("--context_type " + "EDH_CLUSTER_ResourceManager" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("EDH_CLUSTER_ResourceManagerScheduler", context.EDH_CLUSTER_ResourceManagerScheduler);
                    paraList_tRunJob_2.add("--context_type " + "EDH_CLUSTER_ResourceManagerScheduler" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("EDH_CLUSTER_StagingDirectory", context.EDH_CLUSTER_StagingDirectory);
                    paraList_tRunJob_2.add("--context_type " + "EDH_CLUSTER_StagingDirectory" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("EDH_CLUSTER_username", context.EDH_CLUSTER_username);
                    paraList_tRunJob_2.add("--context_type " + "EDH_CLUSTER_username" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("EDH_CLUSTER_yarn_resourcemanager_address_rm1", context.EDH_CLUSTER_yarn_resourcemanager_address_rm1);
                    paraList_tRunJob_2.add("--context_type " + "EDH_CLUSTER_yarn_resourcemanager_address_rm1" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("EDH_CLUSTER_yarn_resourcemanager_address_rm2", context.EDH_CLUSTER_yarn_resourcemanager_address_rm2);
                    paraList_tRunJob_2.add("--context_type " + "EDH_CLUSTER_yarn_resourcemanager_address_rm2" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("EDH_CLUSTER_yarn_resourcemanager_ha_enabled", context.EDH_CLUSTER_yarn_resourcemanager_ha_enabled);
                    paraList_tRunJob_2.add("--context_type " + "EDH_CLUSTER_yarn_resourcemanager_ha_enabled" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("EDH_CLUSTER_yarn_resourcemanager_ha_rm_ids", context.EDH_CLUSTER_yarn_resourcemanager_ha_rm_ids);
                    paraList_tRunJob_2.add("--context_type " + "EDH_CLUSTER_yarn_resourcemanager_ha_rm_ids" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("EDH_CLUSTER_yarn_resourcemanager_scheduler_address_rm1", context.EDH_CLUSTER_yarn_resourcemanager_scheduler_address_rm1);
                    paraList_tRunJob_2.add("--context_type " + "EDH_CLUSTER_yarn_resourcemanager_scheduler_address_rm1" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("EDH_CLUSTER_yarn_resourcemanager_scheduler_address_rm2", context.EDH_CLUSTER_yarn_resourcemanager_scheduler_address_rm2);
                    paraList_tRunJob_2.add("--context_type " + "EDH_CLUSTER_yarn_resourcemanager_scheduler_address_rm2" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("EDH_CLUSTER_HDFS_HdfsFileSeparator", context.EDH_CLUSTER_HDFS_HdfsFileSeparator);
                    paraList_tRunJob_2.add("--context_type " + "EDH_CLUSTER_HDFS_HdfsFileSeparator" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("EDH_CLUSTER_HDFS_HdfsRowSeparator", context.EDH_CLUSTER_HDFS_HdfsRowSeparator);
                    paraList_tRunJob_2.add("--context_type " + "EDH_CLUSTER_HDFS_HdfsRowSeparator" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("EDH_CLUSTER_HIVE_Database", context.EDH_CLUSTER_HIVE_Database);
                    paraList_tRunJob_2.add("--context_type " + "EDH_CLUSTER_HIVE_Database" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("EDH_CLUSTER_HIVE_dynamicPart", context.EDH_CLUSTER_HIVE_dynamicPart);
                    paraList_tRunJob_2.add("--context_type " + "EDH_CLUSTER_HIVE_dynamicPart" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("EDH_CLUSTER_HIVE_dynamicPartMax", context.EDH_CLUSTER_HIVE_dynamicPartMax);
                    paraList_tRunJob_2.add("--context_type " + "EDH_CLUSTER_HIVE_dynamicPartMax" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("EDH_CLUSTER_HIVE_dynamicPartMaxPerNode", context.EDH_CLUSTER_HIVE_dynamicPartMaxPerNode);
                    paraList_tRunJob_2.add("--context_type " + "EDH_CLUSTER_HIVE_dynamicPartMaxPerNode" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("EDH_CLUSTER_HIVE_executionEngine", context.EDH_CLUSTER_HIVE_executionEngine);
                    paraList_tRunJob_2.add("--context_type " + "EDH_CLUSTER_HIVE_executionEngine" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("EDH_CLUSTER_HIVE_hiveAdditionalJDBCParameters", context.EDH_CLUSTER_HIVE_hiveAdditionalJDBCParameters);
                    paraList_tRunJob_2.add("--context_type " + "EDH_CLUSTER_HIVE_hiveAdditionalJDBCParameters" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("EDH_CLUSTER_HIVE_HiveKeyTab", context.EDH_CLUSTER_HIVE_HiveKeyTab);
                    paraList_tRunJob_2.add("--context_type " + "EDH_CLUSTER_HIVE_HiveKeyTab" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("EDH_CLUSTER_HIVE_HiveKeyTabPrincipal", context.EDH_CLUSTER_HIVE_HiveKeyTabPrincipal);
                    paraList_tRunJob_2.add("--context_type " + "EDH_CLUSTER_HIVE_HiveKeyTabPrincipal" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("EDH_CLUSTER_HIVE_HivePrincipal", context.EDH_CLUSTER_HIVE_HivePrincipal);
                    paraList_tRunJob_2.add("--context_type " + "EDH_CLUSTER_HIVE_HivePrincipal" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("EDH_CLUSTER_HIVE_hiveSSLTrustStorePassword", context.EDH_CLUSTER_HIVE_hiveSSLTrustStorePassword);
                    paraList_tRunJob_2.add("--context_type " + "EDH_CLUSTER_HIVE_hiveSSLTrustStorePassword" + "=" + "id_Password");
                    parentContextMap_tRunJob_2.put("EDH_CLUSTER_HIVE_hiveSSLTrustStorePath", context.EDH_CLUSTER_HIVE_hiveSSLTrustStorePath);
                    paraList_tRunJob_2.add("--context_type " + "EDH_CLUSTER_HIVE_hiveSSLTrustStorePath" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("EDH_CLUSTER_HIVE_Login", context.EDH_CLUSTER_HIVE_Login);
                    paraList_tRunJob_2.add("--context_type " + "EDH_CLUSTER_HIVE_Login" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("EDH_CLUSTER_HIVE_Password", context.EDH_CLUSTER_HIVE_Password);
                    paraList_tRunJob_2.add("--context_type " + "EDH_CLUSTER_HIVE_Password" + "=" + "id_Password");
                    parentContextMap_tRunJob_2.put("EDH_CLUSTER_HIVE_Port", context.EDH_CLUSTER_HIVE_Port);
                    paraList_tRunJob_2.add("--context_type " + "EDH_CLUSTER_HIVE_Port" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("EDH_CLUSTER_HIVE_Server", context.EDH_CLUSTER_HIVE_Server);
                    paraList_tRunJob_2.add("--context_type " + "EDH_CLUSTER_HIVE_Server" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("EDH_CLUSTER_IMPALA_Database", context.EDH_CLUSTER_IMPALA_Database);
                    paraList_tRunJob_2.add("--context_type " + "EDH_CLUSTER_IMPALA_Database" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("EDH_CLUSTER_IMPALA_ImpalaPrincipal", context.EDH_CLUSTER_IMPALA_ImpalaPrincipal);
                    paraList_tRunJob_2.add("--context_type " + "EDH_CLUSTER_IMPALA_ImpalaPrincipal" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("EDH_CLUSTER_IMPALA_Login", context.EDH_CLUSTER_IMPALA_Login);
                    paraList_tRunJob_2.add("--context_type " + "EDH_CLUSTER_IMPALA_Login" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("EDH_CLUSTER_IMPALA_Port", context.EDH_CLUSTER_IMPALA_Port);
                    paraList_tRunJob_2.add("--context_type " + "EDH_CLUSTER_IMPALA_Port" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("EDH_CLUSTER_IMPALA_Server", context.EDH_CLUSTER_IMPALA_Server);
                    paraList_tRunJob_2.add("--context_type " + "EDH_CLUSTER_IMPALA_Server" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("DB_POSTGRES_configuration_metadata", context.DB_POSTGRES_configuration_metadata);
                    paraList_tRunJob_2.add("--context_type " + "DB_POSTGRES_configuration_metadata" + "=" + "id_String");
                        }
                    public void transmitAllContext() {
                        transmitContext_0();
                    }
	...
	Object obj_tRunJob_2 = null;
		...
		datahub_aml.s_ingestion_import_file_1_0_1.S_INGESTION_IMPORT_FILE_1 childJob_tRunJob_2 = new datahub_aml.s_ingestion_import_file_1_0_1.S_INGESTION_IMPORT_FILE_1();
	    // pass DataSources
	    ...
	    if (null != talendDataSources_tRunJob_2) {
			...
			log.info("tRunJob_2 - The child job 'datahub_aml.s_ingestion_import_file_1_0_1.S_INGESTION_IMPORT_FILE_1' starts on the version '0.1' with the context 'LOCAL'.");
		...
		String[][] childReturn_tRunJob_2 = childJob_tRunJob_2.runJob((String[]) paraList_tRunJob_2.toArray(new String[paraList_tRunJob_2.size()]));
			...
			log.info("tRunJob_2 - The child job 'datahub_aml.s_ingestion_import_file_1_0_1.S_INGESTION_IMPORT_FILE_1' is done.");
 ...
 */
    ...
    public static void main(String[] args){
        final S_INGESTION_IMPORT_IN S_INGESTION_IMPORT_INClass = new S_INGESTION_IMPORT_IN();

        int exitCode = S_INGESTION_IMPORT_INClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'S_INGESTION_IMPORT_IN' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
			...
			log.info("TalendJob: 'S_INGESTION_IMPORT_IN' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = S_INGESTION_IMPORT_IN.class.getClassLoader().getResourceAsStream("datahub_aml/s_ingestion_import_in_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = S_INGESTION_IMPORT_IN.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : S_INGESTION_IMPORT_IN");
        }
		if(enableLogStash) {
...
/************************************************************************************************
 *     242261 characters generated by Talend Big Data Platform 
